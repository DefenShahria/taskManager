...
class _NewtaskState extends State<Newtask> {
  ...
  bool _getcountprogress = false,_getnewtask =false;
          ...
          children: [
            ...
            _getcountprogress
              ...
              itemBuilder: (context, index) {
                  return SizedBox(
                    child: taskcount(
                      title: _summarycount.data![index].sId??'New',
              ...
              child: RefreshIndicator(
                ...
                child: _getnewtask
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return listdesign(
                            data: _taskListModel.data![index], onDeletTap: () {
                            delettask(_taskListModel.data![index].sId!);
                          }, onEditTap: () {
                             // showEditBottomSheet(_taskListModel.data![index]);
                              statusdataBottomSheet(_taskListModel.data![index]);
                          },
                          );
                        },
                        separatorBuilder: (BuildContext context, int index) {
